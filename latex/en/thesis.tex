...
\section{Auxilliary plots}
\subsection{No penalty}
\label{attachment:nopenalty}
\begin{figure}[H]
\centering
\begin{subfigure}[t]{.48\textwidth}
  \includegraphics[width=\linewidth]{../img/no_penalty/evaluation_3_train_train_no_penalty.pdf}
  \label{fig:histogram_no_penalty_tra}
  \caption{Histogram of number of leaves in the scenario tree for reinforcement agent without penalty evaluated on $TrA$.}
\end{subfigure}
\begin{subfigure}[t]{.48\textwidth}
  \includegraphics[width=\linewidth]{../img/no_penalty/evaluation_5_train_train_no_penalty.pdf}
  \label{fig:boxplots_no_penalty_tra}
  \caption{Boxplots of achieved rewards by number of stages in the scenario tree for reinforcement agent without penalty evaluated on $TrA$. Note that there are only very few observations for the reinforcement agent with 4 stages.}
\end{subfigure}
\caption{Evaluation of reinforcement agent without penalty on $TrA$.}
\end{figure}

\begin{figure}[H]
\centering
\begin{subfigure}[t]{.48\textwidth}
  \includegraphics[width=\linewidth]{../img/no_penalty/evaluation_3_train_test_no_penalty.pdf}
  \label{fig:histogram_no_penalty_tra}
  \caption{Histogram of number of leaves in the scenario tree for reinforcement and random agent without penalty evaluated on $TrB$.}
\end{subfigure}
\begin{subfigure}[t]{.48\textwidth}
  \includegraphics[width=\linewidth]{../img/no_penalty/evaluation_5_train_test_no_penalty.pdf}
  \label{fig:boxplots_no_penalty_tra}
  \caption{Boxplots of achieved rewards by number of stages in the scenario tree for reinforcement  and random agent without penalty evaluated on $TrB$. Note that there are only very few observations with 4 stages. This figure implies that the agent indeed chose the three stage trees correctly to maximise the reward.}
\end{subfigure}
\caption{Evaluation of reinforcement and random agent without penalty on $TrB$.}
\end{figure}
